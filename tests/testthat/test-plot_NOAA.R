test_that("plot of NOAA atlas works", {
  ...
  vdiffr::expect_doppelganger("NOAA word map", plot_NOAA(base, points, epsg = NULL))
  vdiffr::expect_doppelganger("NOAA word map", plot_NOAA(base, points, epsg = "original"))
  vdiffr::expect_doppelganger("NOAA word map", plot_NOAA(base, points, epsg = 4326))
  vdiffr::expect_doppelganger("NOAA word map", plot_NOAA(base, points, epsg = "4326"))
  vdiffr::expect_doppelganger("NOAA arctic map", plot_NOAA(base, epsg = 3995))
  vdiffr::expect_doppelganger("NOAA antarctic map", plot_NOAA(base, epsg = 3031))
})
