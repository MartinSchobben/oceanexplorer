...
The goal of oceanexplorer is to enable ease access and exploration of the [WORLD OCEAN ATLAS](https://www.nodc.noaa.gov/OC5/SELECT/woaselect/woaselect.html) of the US agency [NOAA](https://www.ncei.noaa.gov/).
...
The package allows extraction of global databases of several physical and chemical parameteres of the ocean from the NOAA WORLD OCEAN ATLAS.
