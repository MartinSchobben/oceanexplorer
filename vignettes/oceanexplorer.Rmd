...
In this document I will explain the basic use cases of all three application types. But first a word on the back-end of this R package. This package heavily relies on geospatial data analysis facilitated by *sf* [@sf] for vectors and *stars* [@stars] for raster data (e.g. the NOAA data). I highly recommend reading the accompanying documentation of these packages if you intend to work with the NOAA datasets:
